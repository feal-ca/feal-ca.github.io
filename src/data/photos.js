...
//
// Deliberately no location field: the source files carry no place metadata
// and guessing at them would put invented facts on a public page.
// TODO(ferran): add a `place` to each entry and render it beside the year.
...
export const photos = [
  ...
  },
  {
    ...
    year: 2024,
    alt: "A white-walled house with dark upswept gables and latticed windows, a tall palm rising through the centre of the frame.",
  },
  {
    src: mausoleumSquare,
    title: "The square",
